...
public class PizzaDTO extends AbstractAudiDTO {
	...
	public PizzaDTO(String name, String company, PizzaSize size, boolean cheese, double price, String flavour,String type,
