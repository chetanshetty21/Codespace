...
public class Currency {
	...
	public boolean equals(Object object) {
		if (object instanceof Currency) {
			...
			if (this.name.equals(currency.name) && this.companyName.equals(currency.companyName)
					&& this.color.equals(currency.color) && this.productionArea.equals(currency.productionArea)
