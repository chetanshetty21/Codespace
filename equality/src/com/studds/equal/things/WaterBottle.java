...
public class WaterBottle {
	...
	public WaterBottle(String brand, String name, double price, String color, int quainty, boolean qulaity,
	...
	public boolean equals(Object others) {
		...
		if (others instanceof WaterBottle) {
			WaterBottle casted = (WaterBottle) others;
			if (this.brand.equals(casted.brand) && this.color.equals(casted.color) && this.name.equals(casted.name)) {
	...
	public String toString() {
		return "WaterBottle [brand=" + brand + ", name=" + name + ", price=" + price + ", color=" + color + ", quainty="
